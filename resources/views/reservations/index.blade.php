<x-app-layout>
    ...
    <table class="w-[80%] text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mt-4 ">
        ...
        href="{{route('reservations.create')}}"
         class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mt-4 mx-[40px]">Ajouter reservation</a>
